// talvez alguma coisa aqui nessa linha ?
let contador = 0;
const divText = document.querySelector("#contagem-display-div");
function clicouMenos() {
	// ?
	contador = contador - 1;
	divText.innerText = porExtenso(contador);
}
...
// Exemplos de uso:
// porExtenso(-1) => "menos um"
// porExtenso(0) => "zero"
// porExtenso(11) => "onze"
// etc.
function porExtenso(num, c) {
	// Crédito:
